...
const Faq = () => {
    return (
        <section className="bg-[#F4F5FF] px-6 sm:px-[72px] lg:px-28 py-14 sm:py-[72px] lg:py-28 max-w-full mx-auto">
            <h2 className="font-bold text-[40px] lg:text-[56px]  text-center mb-[72px]">Frequently asked questions</h2>
            <div className="">
                <Disclosure>
                    {({ open }) => (
                        <>
                            <Disclosure.Button className={`flex justify-between w-full text-sm font-medium text-left ${open ? 'text-[#4759F9] pb-0' : 'text-[#1D1E25] pb-8'}`}>
                                <h2 className="text-2xl font-bold">01. What is PayPulse?</h2>
                                {open ? <MinusIcon /> : <PlusIcon />}

                            </Disclosure.Button>
                            <Disclosure.Panel className={`  text-sm text-[#454C5D]
                            ${open ? 'pb-8 pt-3' : 'pb-0'}
                        `}>
